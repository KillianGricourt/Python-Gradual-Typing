...
export class Checker extends ParseTreeWalker {
    ...
    protected _validateGeneratorReturnType(node: FunctionNode, functionType: FunctionType) {
    ...
    protected _validateFunctionTypeVarUsage(node: FunctionNode, functionTypeResult: FunctionTypeResult) {
    ...
    protected _validateOverloadAttributeConsistency(node: FunctionNode, functionType: OverloadedFunctionType) {
    ...
    protected _validateOverloadConsistency(
        node: FunctionNode,
    ...
    protected _reportDeprecatedClassProperty(node: FunctionNode, functionTypeResult: FunctionTypeResult) {
        if (
    ...
    protected _validateTypeGuardFunction(node: FunctionNode, functionType: FunctionType, isMethod: boolean) {
    ...
    protected _validateDunderSignatures(node: FunctionNode, functionType: FunctionType, isMethod: boolean) {
    ...
    protected _validateFunctionReturn(node: FunctionNode, functionType: FunctionType) {
    ...
    protected _validateMethod(node: FunctionNode, functionType: FunctionType, classNode: ClassNode) {
