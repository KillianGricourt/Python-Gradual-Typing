...
exports.finishProfile = exports.startProfile = void 0;
...
function startProfile() {
    ...
    pprof === null || pprof === void 0 ? void 0 : pprof.time.start({});
    console.log(`Starting profile : ${counter}`);
}
exports.startProfile = startProfile;
function finishProfile(outputFile) {
    const pprof = getRequire('@datadog/pprof');
    const profile = pprof === null || pprof === void 0 ? void 0 : pprof.time.stop();
    if (profile) {
        const fs = getRequire('fs-extra');
        const buffer = pprof === null || pprof === void 0 ? void 0 : pprof.encodeSync(profile);
