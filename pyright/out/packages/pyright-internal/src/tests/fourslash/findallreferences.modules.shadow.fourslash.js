...
//// [|/*nest1_9*/nest1|].[|{| "name":"module5", "target":"none" |}module1|]
{
    ...
    const nest2ModuleReferences = helper
        .getFilteredRanges((m, d, t) => t === 'module1' && !!d && (!d.target || d.target === 'nest2'))
        .map((r) => {
        return { path: r.fileName, range: helper.convertPositionRange(r) };
    });
    helper.verifyFindAllReferences({
        ...
        nest1_module1: {
            references: helper
                .getFilteredRanges((m, d, t) => t === 'module1' && !!d && (!d.target || d.target === 'nest1'))
                .map((r) => {
                return { path: r.fileName, range: helper.convertPositionRange(r) };
            }),
        },
        module4: {
            references: helper
                .getFilteredRanges((m, d, t) => t === 'module1' && !!d && d.target !== 'none')
                .map((r) => {
                return { path: r.fileName, range: helper.convertPositionRange(r) };
            }),
        },
...
//# sourceMappingURL=findallreferences.modules.shadow.fourslash.js.map