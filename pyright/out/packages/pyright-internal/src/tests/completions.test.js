...
////         case [|"/*marker*/"|]
    ...
    const uri = uri_1.Uri.file(filePath, state.serviceProvider);
    ...
    const result = new completionProvider_1.CompletionProvider(state.program, uri, position, options, vscode_languageserver_1.CancellationToken.None).getCompletions();
...
////         case [|"Quote'/*marker*/"|]
    ...
    const result = new completionProvider_1.CompletionProvider(state.program, uri, position, options, vscode_languageserver_1.CancellationToken.None).getCompletions();
    assert_1.default.strictEqual(result === null || result === void 0 ? void 0 : result.items.length, 0);
});
...
//// def foo(): pass
    ...
    const result = new completionProvider_1.CompletionProvider(state.program, uri, position, options, vscode_languageserver_1.CancellationToken.None).getCompletions();
    const items = result === null || result === void 0 ? void 0 : result.items.filter((i) => i.label === 'os');
    assert_1.default.strictEqual(items === null || items === void 0 ? void 0 : items.length, 2);
    items.sort((a, b) => a.sortText.localeCompare(b.sortText));
    (0, assert_1.default)(!items[0].labelDetails);
    assert_1.default.strictEqual(items[1].labelDetails.description, 'vendored');
});
            ...
            completions: [
                {
                    ...
                    textEdit: {
                        range: state.getPositionRange('marker'),
                        newText: '__call__(self, parser: ArgumentParser, namespace: Namespace, values: str | Sequence[Any] | None, option_string: str | None = None) -> None:\n    return super().__call__(parser, namespace, values, option_string)',
                    },
                },
            ],
        },
            ...
            completions: [
                {
                    ...
                    textEdit: {
                        range: state.getPositionRange('marker'),
                        newText: 'foo(self, func: Callable[P, None], *args: P.args, **kwargs: P.kwargs):\n    return super().foo(func, *args, **kwargs)',
                    },
                },
            ],
        },
